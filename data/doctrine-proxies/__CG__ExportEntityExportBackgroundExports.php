...
namespace DoctrineProxies\__CG__\Export\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ExportBackgroundExports extends \Export\Entity\ExportBackgroundExports implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'created', 'filename', 'extension', 'query', 'resourceType', 'resourcesCount', 'fileUri', 'job'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExportBackgroundExports $proxy) {
    ...
    public function getFileUri()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFileUri', []);

        return parent::getFileUri();
    }
    ...
    public function setFileUri($fileUri)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFileUri', [$fileUri]);

        return parent::setFileUri($fileUri);
    }
