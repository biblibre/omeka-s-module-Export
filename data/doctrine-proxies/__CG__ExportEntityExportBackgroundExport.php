 ...
 */
class ExportBackgroundExport extends \Export\Entity\ExportBackgroundExport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'created', 'filename', 'extension', 'queryParams', 'resourceType', 'filePath', 'job'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExportBackgroundExport $proxy) {
